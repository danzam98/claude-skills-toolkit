...
For broader testing skill, see [`/testing-perfect-e2e-integration-tests-with-logging-and-no-mocks`](../../testing-perfect-e2e-integration-tests-with-logging-and-no-mocks/SKILL.md). This file is the **ticketing-system-specific** addendum: the precise mock shapes, fixtures, and assertions that match the canonical service layer.
...
Wire to a real Postgres instance for the full lifecycle. See [`/testing-perfect-e2e-integration-tests-with-logging-and-no-mocks`](../../testing-perfect-e2e-integration-tests-with-logging-and-no-mocks/SKILL.md) for setup.
