...
Example: $500K engineering cost at Growth Company = $500K x 2.2 = **$1.1M total team cost**
...
**Codebase Version**: [From CLAUDE.md phase status or latest git tag]
...
*Rationale*: [Explain why this rate is appropriate given the tech stack complexity]
