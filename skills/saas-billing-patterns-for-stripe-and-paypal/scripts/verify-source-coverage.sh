...
#
# Reads:
#   /data/projects/je_private_skills_repo/COMPREHENSIVE_GUIDE_TO_SAAS_BILLING_PATTERNS_WITH_STRIPE_AND_PAYPAL.md
...
SOURCE_GUIDE="/data/projects/je_private_skills_repo/COMPREHENSIVE_GUIDE_TO_SAAS_BILLING_PATTERNS_WITH_STRIPE_AND_PAYPAL.md"
