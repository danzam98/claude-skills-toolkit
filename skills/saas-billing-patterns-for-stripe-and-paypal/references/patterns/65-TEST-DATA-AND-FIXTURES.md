...
> **Where this comes from.** § 53 (test-fixture exclusion) + § 69 (real-DB integration tests) + cross-reference with `/testing-real-service-e2e-no-mocks` and `/testing-perfect-e2e-integration-tests-with-logging-and-no-mocks`.
