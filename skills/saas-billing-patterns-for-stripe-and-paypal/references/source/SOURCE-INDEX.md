...
The pattern bundles in `references/patterns/` are distillations of the master guide at `/data/projects/je_private_skills_repo/COMPREHENSIVE_GUIDE_TO_SAAS_BILLING_PATTERNS_WITH_STRIPE_AND_PAYPAL.md`. This file maps each section of the source guide to the pattern bundle that owns it.
