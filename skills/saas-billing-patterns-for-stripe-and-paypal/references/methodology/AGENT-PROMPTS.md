...
Bundle scope is defined in /data/projects/je_private_skills_repo/.claude/skills/saas-billing-patterns-for-stripe-and-paypal/references/patterns/<BUNDLE_FILE>.md (read it first — it tells you which patterns belong to this bundle).
...
Inputs:
- The pattern library at /data/projects/je_private_skills_repo/.claude/skills/saas-billing-patterns-for-stripe-and-paypal/references/patterns/<BUNDLE_FILE>.md
...
- The risk-scoring rubric at /data/projects/je_private_skills_repo/.claude/skills/saas-billing-patterns-for-stripe-and-paypal/references/methodology/RISK-SCORING.md
...
- The greenfield step-ordered build at /data/projects/je_private_skills_repo/.claude/skills/saas-billing-patterns-for-stripe-and-paypal/references/patterns/110-OPERATIONS.md § Battle-tested-checklist (use this even for non-greenfield mode — the dependency relationships still apply)
...
- Re-read the Polish Bar in /data/projects/je_private_skills_repo/.claude/skills/saas-billing-patterns-for-stripe-and-paypal/references/methodology/POLISH-BAR.md
...
For your theme, the rules are at /data/projects/je_private_skills_repo/.claude/skills/saas-billing-patterns-for-stripe-and-paypal/references/methodology/PHASES.md § Phase 6.
...
- Read /data/projects/je_private_skills_repo/.claude/skills/saas-billing-patterns-for-stripe-and-paypal/references/methodology/POLISH-BAR.md and check every Polish Bar dimension on every changed file.
...
- Reference: /data/projects/je_private_skills_repo/.claude/skills/saas-billing-patterns-for-stripe-and-paypal/references/patterns/110-OPERATIONS.md § Real-DB integration tests
...
Scenario list and exact steps are in /data/projects/je_private_skills_repo/.claude/skills/saas-billing-patterns-for-stripe-and-paypal/references/methodology/PHASES.md § Phase 9.
...
Source material:
- /data/projects/je_private_skills_repo/COMPREHENSIVE_GUIDE_TO_SAAS_BILLING_PATTERNS_WITH_STRIPE_AND_PAYPAL.md § 74 (operational runbooks) — adapt to this project's reality.
...
- Claude (you, primary)
- Codex (`codex` CLI, see /data/projects/je_private_skills_repo/.claude/skills/multi-model-triangulation/SKILL.md)
- Gemini (`gemini` CLI)
