...
|---------------------|------------------------------|
| `corpus/primary_sources/` | The master guide at `/data/projects/je_private_skills_repo/COMPREHENSIVE_GUIDE_TO_SAAS_BILLING_PATTERNS_WITH_STRIPE_AND_PAYPAL.md`, plus referenced bead trail and cass transcripts. |
