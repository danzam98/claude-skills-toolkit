...
bash /data/projects/je_private_skills_repo/.claude/skills/saas-billing-patterns-for-stripe-and-paypal/scripts/discover-stack.sh /tmp/billing-skill-smoke
...
- [ ] Source-guide reference path is correct (`/data/projects/je_private_skills_repo/COMPREHENSIVE_GUIDE_TO_SAAS_BILLING_PATTERNS_WITH_STRIPE_AND_PAYPAL.md`).
