...
- [Graceful degradation](#graceful-degradation-when-a-skill-is-missing) — inline fallback per referenced skill.
...
|---|---|---|
| `sc` | meta-tool — referenced only during this skill's authoring | none needed at runtime |
| `sw` | meta-tool — referenced only during this skill's authoring | none needed at runtime |
...
| `comprehensive-codebase-report` | Onboarding Phase 2 (architecture report) | template inlined in [assets/ONBOARDING-TEMPLATE.md](../assets/ONBOARDING-TEMPLATE.md) |
