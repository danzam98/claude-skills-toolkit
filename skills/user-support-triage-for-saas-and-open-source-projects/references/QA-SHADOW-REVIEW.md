...
- [AGENT-ONBOARDING-AND-COACHING.md](../../user-support-ticketing-system-for-saas/references/AGENT-ONBOARDING-AND-COACHING.md)
  is the ticketing-system-side version for productized review queues.
