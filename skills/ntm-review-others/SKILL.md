...
- Periodically during swarm sessions
- When multiple agents have been working in parallel
- Before major commits or releases

## Tips

- Catches integration issues between agent work
- Agents notify each other of fixes via Agent Mail
- Deeper review than self-review
