...
Dependencies: [br-e9b1d4 (User model), br-c4d5e6 (Session management)]
Blocks: [br-a1b2c3 (Protected routes), br-f7g8h9 (User dashboard)]
...
|---------|---------|---------|
| **ID** | Unique identifier | `br-7f3a2c` |
...
```bash
br dep add br-7f3a2c br-e9b1d4  # OAuth depends on User model
br dep add br-7f3a2c br-c4d5e6  # OAuth depends on Session mgmt
```

### Add Labels

```bash
br label add br-7f3a2c auth backend security
```
